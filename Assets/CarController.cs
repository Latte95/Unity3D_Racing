...
public class CarController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Vector3 center = Vector3.zero;
            center += colliders.FLWheel.transform.localPosition;
            center += colliders.FRWheel.transform.localPosition;
            center += colliders.RLWheel.transform.localPosition;
            center += colliders.RRWheel.transform.localPosition;
        center *= 0.25f;
    ...
    void ApplyMotor() {
        ...
        if(colliders.RRWheel.GetGroundHit(out var hit))
        {
            ...
            Debug.Log("≈‰≈© : " + colliders.RLWheel.motorTorque);
